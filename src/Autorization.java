...
public  class Autorization {
    ...
    protected boolean ifLoginExists(String login) throws SQLException{
        ...
        try {
            ...
            connection = DriverManager.getConnection("jdbc:postgresql://localhost:1379/library", "postgres", "soliddude");
        } catch (Exception e) {
            e.printStackTrace();
    ...
    protected void SignUp() throws SQLException, NoSuchAlgorithmException {
